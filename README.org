...
Simula is untested on machines with AMD drivers, though AMD cards running mesa drivers should be supported. If you do not have ~nix~, you can install it via
