...
[[https://www.wolframcloud.com/obj/george.w.singer/TextQuality.gif]]

The left image is a VR terminal *without* our filter applied; the right is the same image *with* our filter applied. Compared to other VR Desktops, Simula allows significantly longer sessions without uncomfortable eye strain.
