...
let
    ...
    devBuildFalse = ''
      ...
      echo "PATH=${xwayland}/bin:${xkbcomp}/bin:\$PATH LD_LIBRARY_PATH=${SDL2}/lib:${vulkan-loader}/lib \$(./result/bin/GetNixGL.sh) ${godot}/bin/godot.x11.opt.64 -m 2>&1 | ${coreutils}/bin/tee output.file" >> $out/bin/simula
