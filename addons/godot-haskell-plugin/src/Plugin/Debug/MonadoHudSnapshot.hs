...
buildDebugMonadoHudSnapshot now path state =
  DebugMonadoHudSnapshot
    ...
    , debugMonadoHudSnapshotLatestOpenXRFrameTimingSample = monadoTimedValue <$> lastMaybe openXRSamples
    , debugMonadoHudSnapshotWorstOpenXRGodotFrameStartToXrWaitFrameWindowMs = maxMaybe openXRGodotFrameStartToXrWaitFrameValues
    , debugMonadoHudSnapshotWorstOpenXRGodotFrameStartToXrWaitFrameSessionMs = monadoHudStateWorstOpenXRGodotFrameStartToXrWaitFrameSessionMs state
    , debugMonadoHudSnapshotAvgOpenXRGodotFrameStartToXrWaitFrameMs = average openXRGodotFrameStartToXrWaitFrameValues
    , debugMonadoHudSnapshotWorstOpenXRXrWaitFrameSleepWindowMs = maxMaybe openXRXrWaitFrameSleepValues
    , debugMonadoHudSnapshotWorstOpenXRXrWaitFrameSleepSessionMs = monadoHudStateWorstOpenXRXrWaitFrameSleepSessionMs state
    , debugMonadoHudSnapshotAvgOpenXRXrWaitFrameSleepMs = average openXRXrWaitFrameSleepValues
    , debugMonadoHudSnapshotOpenXRFrameTimingSampleCount = length openXRSamples
    , debugMonadoHudSnapshotLastOpenXRFrameTimingDrainCount = monadoHudStateLastOpenXRFrameTimingDrainCount state
    , debugMonadoHudSnapshotLatestGhcGCFrameTimingSample = monadoTimedValue <$> lastMaybe ghcGCSamples
    , debugMonadoHudSnapshotWorstGhcGCTimeWindowMs = maxMaybe ghcGCTimeValues
    , debugMonadoHudSnapshotWorstGhcGCTimeSessionMs = monadoHudStateWorstGhcGCTimeSessionMs state
    , debugMonadoHudSnapshotAvgGhcGCTimeMs = average ghcGCTimeValues
    , debugMonadoHudSnapshotGhcGCFrameTimingSampleCount = length ghcGCSamples
    , debugMonadoHudSnapshotLastGhcGCFrameTimingDrainCount = monadoHudStateLastGhcGCFrameTimingDrainCount state
    , debugMonadoHudSnapshotGhcGCStatsEnabled = monadoHudStateGhcGCStatsEnabled state
    , debugMonadoHudSnapshotWorstNonGCGodotFrameStartToXrWaitFrameWindowMs = nonGCGodotFrameStartToXrWaitFrameWindow
    , debugMonadoHudSnapshotWorstNonGCGodotFrameStartToXrWaitFrameSessionMs = nonGCGodotFrameStartToXrWaitFrameSession
    , debugMonadoHudSnapshotAvgNonGCGodotFrameStartToXrWaitFrameMs = nonGCGodotFrameStartToXrWaitFrameAverage
  ...
  where
    ...
    openXRSamples = Foldable.toList (monadoHudStateOpenXRFrameTimingSamples trimmed)
    ghcGCSamples = Foldable.toList (monadoHudStateGhcGCFrameTimingSamples trimmed)
    displayMisses = List.filter (\event -> monadoHudFrameSkipEventKind event == MonadoHudDisplayMiss) frameSkipEvents
    openXRGodotFrameStartToXrWaitFrameValues = fmap (openXRFrameTimingSampleGodotFrameStartToXrWaitFrameMs . monadoTimedValue) openXRSamples
    openXRXrWaitFrameSleepValues = fmap (openXRFrameTimingSampleXrWaitFrameSleepMs . monadoTimedValue) openXRSamples
    ghcGCTimeValues = fmap (ghcGCFrameTimingSampleGcMs . monadoTimedValue) ghcGCSamples
    nonGCGodotFrameStartToXrWaitFrameAverage = (-) <$> average openXRGodotFrameStartToXrWaitFrameValues <*> average ghcGCTimeValues
    nonGCGodotFrameStartToXrWaitFrameWindow = (-) <$> maxMaybe openXRGodotFrameStartToXrWaitFrameValues <*> maxMaybe ghcGCTimeValues
    nonGCGodotFrameStartToXrWaitFrameSession = (-) <$> monadoHudStateWorstOpenXRGodotFrameStartToXrWaitFrameSessionMs state <*> monadoHudStateWorstGhcGCTimeSessionMs state
