...
, vector, fetchFromGitHub, callPackage, haskellPackages, devBuild ? false, onNixOS ? false, pkgs ? (import ../../pinned-nixpkgs.nix), ordered-containers, process-extras, dhall, hspec, QuickCheck, cabal-install
}:
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    stm text time unix uuid vector ordered-containers process-extras dhall hspec QuickCheck
  ];
