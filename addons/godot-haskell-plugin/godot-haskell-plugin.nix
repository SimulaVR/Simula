...
, vector, fetchFromGitHub, callPackage, haskellPackages, devBuild ? false, onNixOS ? false, pkgs ? (import ../../pinned-nixpkgs.nix), godot, godot-haskell, ordered-containers, process-extras, dhall
}:
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    stm text time unix uuid vector godot-haskell ordered-containers process-extras dhall
  ];
