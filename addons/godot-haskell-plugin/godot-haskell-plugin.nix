...
, vector, fetchFromGitHub, haskellPackages, devBuild ? false, onNixOS ? false, godot, godot-haskell, ordered-containers, process-extras, dhall, hspec, QuickCheck, safe-exceptions, io-streams, path, path-io
, lib
}:
mkDerivation {
