...
let Configuration =
  ...
  , _defaultWindowScale      = 1                      -- In addition to resolution, apps can be scaled up or down by this factor
  , _keyBindings             = [ -- For keyboard shortcuts, use keynames from
                              ...
                              , { _keyCombination = ["KEY_MASK_META", "KEY_SLASH"]      , _keyAction = "terminalLaunch" }
