...
vertexSource ShaderSimulaVRModelRay = $(embedFile "shaders/simulavrmodelray.vert")
...
fragSource ShaderSimulaVRModelRay = $(embedFile "shaders/simulavrmodelray.frag")
